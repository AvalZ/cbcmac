...
def main():
    ...
    # file_data2[0:BLOCK_SIZE] = file_data2[0:BLOCK_SIZE]
    file_data1 = cbc.pad(file_data1)
    forged_block = sxor.strxor(file_data2[0:BLOCK_SIZE],mac1)

    forged = file_data1 + forged_block + file_data2[BLOCK_SIZE:]
